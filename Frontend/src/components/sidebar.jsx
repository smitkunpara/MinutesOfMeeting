                    ...
                    <div className="h-full">
                        ...
                        {!isLoggedIn ? (<div className="flex flex-col item-center justify center h-full w-full" >
                            ...
                            (<>
                                ...
                                <button onClick={()=>{setIsOpenSideBar(false); handleDialogOpenUpload()}} className="flex text-white w-full items-center justify-center bg-blue-500 border-0 py-4 px-12 focus:outline-none hover:bg-blue-600 rounded-full mx-auto">Upload 
