        ...
        <nav className="navbar px-4 ">
          <div className='flex w-full justify-between '>
            ...
            <button onClick={handleDialogOpen}
              className="lg:flex md:flex hidden text-white items-center justify-center bg-blue-500 border-0 py-4 px-8 mr-6 focus:outline-none hover:bg-blue-600 rounded-full">
              Upload
