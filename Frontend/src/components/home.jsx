  ...
  return (
    <div className="body">
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-12 py-28 mx-auto flex items-center justify-center">
          <div className="lg:w-2/5 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            <h1 className="text-gray-900 text-5xl title-font font-bold mb-4">Audio to Text</h1>
            <p className="leading-relaxed mb-4 my-8">Transcribe audio to text automatically, using AI. Over +120 languages supported.</p>
            <UploadBox isOpen={isOpen} onClose={() => setIsOpen(false)} />
            <button onClick={handleDialogOpen} className="flex text-white items-center justify-center bg-blue-500 border-0 py-4 px-12 focus:outline-none hover:bg-blue-600 rounded-full">Transcribe your audio to text <div className="shadow-neutral-1000/25 -mr-[15px] grid items-center justify-center rounded-full p-3 mx-3 shadow-xl bg-white text-blue-600  rtl:-scale-x-100" bis_skin_checked="1"><svg stroke="currentColor" fill="none" stroke-width="2" viewBox="0 0 24 24" stroke-linecap="round" stroke-linejoin="round" className="h-[18px] w-[18px]" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><polyline points="16 16 12 12 8 16"></polyline><line x1="12" y1="12" x2="12" y2="21"></line><path d="M20.39 18.39A5 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3"></path><polyline points="16 16 12 12 8 16"></polyline></svg></div></button>
          </div>
          <img alt="ecommerce" className="lg:w-3/5 w-full lg:h-auto h-64 object-cover object-center rounded" style={{ objectFit: 'contain' }} src="https://cdn-site-assets.veed.io/cdn-cgi/image/width=1280,quality=75,format=auto/Audio_to_Text_26b67a012c/Audio_to_Text_26b67a012c.png" />
        </div>
      ...
      <section className="text-gray-600 body-font">
        <div className="container px-5 py-24 mx-auto" bis_skin_checked="1">
          ...
          <div className="flex flex-wrap -m-4" bis_skin_checked="1">
            <div className="p-4 lg:w-1/3 md:w-1/2" bis_skin_checked="1">
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-12 py-28 mx-auto flex items-center justify-center">
          ...
          <img alt="ecommerce" className="lg:w-1/2 w-full lg:h-auto h-64 object-cover object-center rounded" style={{ objectFit: 'contain' }} src="https://cdn-site-assets.veed.io/cdn-cgi/image/width=1024,quality=75,format=auto/Instant_transcription_downloads_for_better_documentation_ddcb6e11a1/Instant_transcription_downloads_for_better_documentation_ddcb6e11a1.png" />
        </div>
      </section>
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-12 py-28 mx-auto flex items-center justify-center">
          <img alt="ecommerce" className="lg:w-1/2 lg:pr-10 w-full lg:h-auto h-64 object-cover object-center rounded " style={{ objectFit: 'contain' }} src="https://cdn-site-assets.veed.io/cdn-cgi/image/width=1024,quality=75,format=auto/Convert_audio_to_text_and_create_globally_accessible_content_8373047d0a/Convert_audio_to_text_and_create_globally_accessible_content_8373047d0a.png" />
          <div className="lg:w-1/2 w-full lg:pr-10 lg:py-6 mb-6 lg:mb-0">
            <h1 className="text-gray-900 text-2xl title-font font-bold mb-4">Instant transcription downloads for better documentation</h1>
            <p className="leading-relaxed mb-4 my-8">VEED uses cutting-edge technology to transcribe your audio to text at lightning-fast speed. Download your transcript in one click and keep track of your records better—without paying for expensive transcription services. Get a written copy of your recordings instantly and one proofread for 100% accuracy. Downloading transcriptions is available to premium subscribers. Check our pricing page for more info.</p>
          </div>
