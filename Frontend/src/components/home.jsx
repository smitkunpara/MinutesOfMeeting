  ...
  return (
    <div className="body">
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-5 py-28 mx-auto flex flex-col lg:flex-row items-center justify-center">
          ...
          <div className="flex-column lg:p-12 py-2 lg:w-1/2 lg:pr-10 lg:py-6 mb-6 lg:mb-0 justify-center order-2 lg:order-1">
      ...
      <section className="text-gray-600 body-font overflow-hidden">
        <div className="container px-12 py-28 mx-auto flex flex-col lg:flex-row items-center justify-center">
