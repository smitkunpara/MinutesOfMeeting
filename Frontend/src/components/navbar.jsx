...
const Navbar1 = ({ onPage, setNormalHighlight, setFollowHighligh }) => {
    ...
    return (<>
        <SideBar ExportasExcel={ExportasExcel} ExportasJSON={ExportasJSON} onPage={onPage} Normal={Normal} Follow={Follow} handleNormalHighlight={handleNormalHighlight} handleFollowHighlight={handleFollowHighlight} isOpenSideBar={isOpenSideBar} isLoggedIn={isLoggedIn} meetings={meetings} />
